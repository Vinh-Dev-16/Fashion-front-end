  ...
  >
    ...
    <div class="flex shadow-md">
      ...
      >
        <div class="w-72">
          <!-- Heading -->
          <h1 class="text-xl font-semibold">Fashion project</h1>
          <small class="text-gray-400"
            >Vui lòng điền thông tin đăng nhập</small
          >
      ...
      <div
        ...
        style="width: 24rem; height: 32rem"
      >
      <img src="login.jpg"  class="w-full h-full bg-center bg-no-repeat bg-cover rounded-r-md border-l border-solid border-slate-300"/>
      </div>
    </div>
    </div>
